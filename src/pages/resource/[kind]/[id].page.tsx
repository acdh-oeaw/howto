...
import { type Post as PostData, type PostPreview } from "@/cms/api/posts.api";
	...
	return (
		<Fragment>
			...
			<PageContent>
				...
				<div className="mx-auto grid w-full max-w-screen-lg space-y-10 px-10 pb-16 pt-12 2xl:max-w-none 2xl:grid-cols-content-columns 2xl:gap-x-10 2xl:space-y-0">
