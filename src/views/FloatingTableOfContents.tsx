	...
	return (
		<nav aria-label={t("common.tableOfContents")}>
			<button
				{...openButtonProps}
				ref={openButtonRef}
				className="fixed bottom-16 right-6 flex h-12 w-12 items-center justify-center rounded-full bg-brand-blue text-white transition hover:bg-brand-light-blue"
			>
