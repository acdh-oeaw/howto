...
One central controlled vocabulary in _VieCPro_ categorizes the functions/roles/occupations (Funktionsbezeichnungen) at the Viennese Court (see: <Download href="/assets/content/resources/prosopographic-modelling-vocabularies/viecpro-vocabs.skos.ttl" title="viecpro-vocabs.skos.ttl" />.
...
Closely corresponding to the Funktionsbezeichnung of _VieCPro_, in _NAMPI_ there is a classification of religious status and occupation. However, partly owing to the factoid-based data model, it is not represented as skos:Concepts, but rather as subClass hierarchy of the generic concept `Aspect`, defined in the dedicated <Download href="/assets/content/resources/prosopographic-modelling-vocabularies/monastic-life.owl" title="monastic-life ontology"/>:
...
For the purpose of this exercise we've derived a controlled vocabulary from the original data in SKOS (see: <Download title="nampiSkos.ttl" href="/assets/content/resources/prosopographic-modelling-vocabularies/nampiSkos.ttl"/>).
