...
summary: >-
  This is a basic tutorial on how to perform queries in the corpus query engine
  Sketch Engine. More specifically, it focuses on introducing Sketch Engine’s
  “Corpus Query Language” (CQL).

  The tutorial is aimed to provide users of the Austrian Media Corpus (amc) with
  an easy entry point to query the amc using the Sketch Engine and CQL.
  Therefore the tutorial is deliberately provided in German language. All
  examples in the tutorial are directly taken from the amc. 
locale: de
authors:
  - pirker-hannes
editors:
