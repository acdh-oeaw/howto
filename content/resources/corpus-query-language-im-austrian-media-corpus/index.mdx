...
<Quiz>
  <QuizMultipleChoice question="Welche der Aussagen treffen auf den Begriff &#x22;Token'&#x22;zu?" answers={[{"answer":"Einem Token können zusätzliche Informationen in Form von Attributen zugeordnet werden.","kind":"correct"},{"answer":"Ein Token ist eine linguistisch sinnvolle Einheit.","kind":"correct"},{"answer":"Abkürzungen enthalten als Token auch Satzzeichen und dürfen nicht von diesen getrennt werden.","kind":"correct"},{"answer":"Satzzeichen bilden eigene Token.","kind":"correct"},{"answer":"Ein Token ist ein orthographisches Wort.","kind":"incorrect"}]} messages={{"correct":"Richtig! Meistens sind orthographische Worte auch Token, aber auch Satzzeichen und Abkürzungen werden zu Token.","incorrect":"Falsch!"}} />

  <QuizMultipleChoice question="Welche Informationen können aus Token-Attributen nicht erlesen werden?" answers={[{"answer":"Angaben zum Autor/zur Autorin des Textes","kind":"correct"},{"answer":"Angaben zur Morphologie eines Tokens","kind":"incorrect"},{"answer":"Angaben zu synonymer Verwendung des Tokens","kind":"correct"},{"answer":"Angaben zum Lemma des Tokens","kind":"incorrect"}]} messages={{"correct":"Richtig!","incorrect":"Token-Attribute beschreiben einzelne Token näher, nicht den gesamten Text, in dem die Token vorkommen."}} />

  <QuizMultipleChoice question="Wählen Sie bitte die richtige Antwort aus." answers={[{"answer":"Das amc beinhaltet Zeitungsartikel aus österreichischen Printmedien.","kind":"incorrect"},{"answer":"Das amc ist eine Kooperation des ACDH-CH und der APA, die Texte für sprachwissenschaftliche Fragestellungen zur Verfügung stellt.","kind":"incorrect"},{"answer":"Das amc ist ein Textcorpus, das aufgrund der linguistischen Annotation mithilfe der NoSketch-Engine und der Corpus Query Language durchsucht werden kann.","kind":"incorrect"},{"answer":"Alle genannten Antworten sind richtig.","kind":"correct"}]} messages={{"correct":"Richtig!","incorrect":"Falsch!"}} />
</Quiz>
...
<Quiz>
  <QuizSingleChoice question="Wie nennt man den Operator, mit dem eine Minimal und/ oder Maximalanzahl an Wiederholungen eines Ausdrucks festgelegt werden kann? Welche Zeichen werden genutzt?" answers={[{"answer":"strange Operator, { }","kind":"incorrect"},{"answer":"length Operator, [ ]","kind":"incorrect"},{"answer":"ranges Operator, { }","kind":"correct"},{"answer":"distance Operator, [ ]","kind":"incorrect"}]} messages={{"correct":"Genau, der ranges Operator ist gesucht. In den Klammern stehen die Minimal-, und Maximalwerte.","incorrect":"Überlegen Sie noch einmal!"}} />

	<QuizMultipleChoice question="Veränderung Sie die Suchanfrage unten so, dass die Begriffe wie &#x22;klimaneutral&#x22;, &#x22;klimatisiert&#x22;, &#x22;klimageschichtlich&#x22; und &#x22;klimaschonend&#x22; gefunden werden können, die Begriffe &#x22;klimatisch&#x22; und &#x22;Klima&#x22; aber nicht gefunden werden." answers={[{"answer":"TODO: XMLEDITOR `<Quiz.XmlCodeEditor code={\"[word=\\\"klima\\\"]\"} solution={\"[word=\\\"klima.{7,}\\\"]\"} validate=\"input\">`","kind":"incorrect"}]} messages={{"correct":"Genau! Ein Minimalwert von {7} muss gegeben sein, ein Maximalwert ist nicht notwendig.","incorrect":"Überlegen Sie noch einmal. Welche Zeichen benutzt der Operator? Wie viele beliebige Zeichen müssen zumindest auf \"klima\" folgen?"}} />

  <QuizSingleChoice question="Die folgende Suche `[word=&#x22;klima.{2,}&#x22; & posTT!=&#x22;NN&#x22;]` liefert als Ergebnisse &#x22;klimatechnische&#x22;, &#x22;klimatisierte&#x22;, &#x22;klimabegünstigt&#x22;, &#x22;klimabedingt&#x22;, und &#x22;klimatisch&#x22;. &#x22;Klimaschutz&#x22;, &#x22;Klimagerät&#x22;, &#x22;Klimawandelleugner&#x22; werden aber nicht gefunden. Warum?" answers={[{"answer":"Die Worte \"Klimaschutz\", \"Klimagerät\", \"Klimawandelleugner\" überschreiten die Maximalanzahl an Wiederholungen nach dem Ausdruck \"klima.\"","kind":"incorrect"},{"answer":"Aufgrund des logischen UND müssen zwei Kriterien erfüllt sein:  der Ausdruck \"klima.\" muss vorkommen, UND es darf durch TreeTagger nicht als Nomen markiert worden sein.","kind":"correct"},{"answer":"Aufgrund des logischen ODER können nur Treffer gefunden werden, die entweder das Wort \"klima\" beinhalten ODER aber Nomen sind. Bei zwei ausschließenden Kriterien wird immer nur das erste Kriterium unbedingt erfüllt.","kind":"incorrect"}]} messages={{"correct":"Ganz genau! Beide Kriterien müssen vom Suchergebnis erfüllt werden.","incorrect":"Überlegen Sie nochmal!"}} />

  <QuizMultipleChoice question="Mit [] wird eine Auswahl an Zeichen definiert, sodass ein Suchergebnis oft der Verwendung von | gleich ist (zB `[word=&#x22;h(o|a)se&#x22;]` und `[word=&#x22;h[oa]se&#x22;]` liefern dasselbe Ergebnis). Warum muss eine gemeinsame Suche nach &#x22;Schlund&#x22; oder &#x22;Wund&#x22; dennoch `[word=&#x22;(schl|w)und&#x22;]` lauten?" answers={[{"answer":"Ohne das logische ODER würde nach der gesamten Zeichenfolge gesucht werden.","kind":"correct"},{"answer":"Im Anlaut eines Wortes muss immer mit logischem ODER gesucht werden.","kind":"incorrect"}]} messages={{"correct":"Richtig!","incorrect":"Falsch!"}} />
</Quiz>
...
<Quiz>
  <QuizMultipleChoice question="Sehen Sie sich das Sucheregbnis im Bild oben an. Wie könnte die Suchanfrage gelautet haben?" answers={[{"answer":"(meet [lemma=\"schützen\"] [lemma=\"Klima|Kanzler\"] -2 2)","kind":"incorrect"},{"answer":"(meet [lemma=\"schützen\"] [lemma=\"Klima\"] -5 5)","kind":"correct"},{"answer":"(meet [lemma=\"schützen\"] [lemma=\"Klima\"])","kind":"incorrect"},{"answer":"([lemma=\"schützen\"] [lemma=\"Klima|Kanzler\"] -2 2)","kind":"incorrect"}]} messages={{"correct":"Richtig!","incorrect":"Überprüfen Sie, ob der Suchausdruck vollständig ist!"}} />

  <QuizMultipleChoice question="Welche der Aussagen ist falsch?" answers={[{"answer":"Mit meet kann im linken und rechten Kontext eines Ausdrucks gesucht werden.","kind":"incorrect"},{"answer":"Die Nachbarschaft, in der gesucht wird, kann für den linken und rechten Kontext separat festgelegt werden.","kind":"incorrect"},{"answer":"Durch das Nutzen von RegEx können auch Suchen auf der Bedeutungsebene im AMC durchgeführt werden.","kind":"correct"}]} messages={{"correct":"Richtig, bei RegEx sind keine semantischen Tags hinterlegt.","incorrect":"Doch, das ist korrekt."}} />
</Quiz>
