...
<Quiz>
	<QuizChoice variant="single">
		...
		<QuizChoiceChoiceAnswer kind="incorrect">
			strange Operator, `{ }`
		</QuizChoiceChoiceAnswer>

		<QuizChoiceChoiceAnswer kind="incorrect">
			length Operator, `[ ]`
		</QuizChoiceChoiceAnswer>

		<QuizChoiceChoiceAnswer kind="correct">
			ranges Operator, `{ }`
		</QuizChoiceChoiceAnswer>
	...
	{/* <QuizXmlCodeEditor code={"[word=\"klima\"]"} solution={"[word=\"klima.{7,}\"]"} validate="input">
		<QuizXmlCodeEditorQuestion>
