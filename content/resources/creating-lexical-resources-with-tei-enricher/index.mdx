...
<Callout kind="note" title="A final word of caution">
Bear in mind that both the program and its documentation are work in progress and as such are incomplete and prone to change. To keep things simple, we only deal with the single-user version of _\<TEI\>Enricher_. While setting-up the XML database BaseX and configuring it is also pretty straightforward, it still adds some complexity to the issue which is not needed when only wanting to look at the basic workings of digital dictionary writing.
</Callout>
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/new_dict__001.png">
Figure 1: Create new dictionary
</Figure>
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/create_dictionary_001.png">
Figure 2: Creating dict. environment
</Figure>
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/dict_fileexplorer_001.png">
Figure 3: Opening new dictionary
</Figure>
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/enricher_struct_001.png">
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/entry_templates_001.png">
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/step_03_1__001.png">
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/step_03_2__001.png">
Figure 7: New lemma
</Figure>
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/step_03_3__001.png">
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/step_03_4__001.png">
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/step_04_1__001.png">
Figure 10: Dict. snippets
</Figure>
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/step_04_2__001.png">
Figure 11: Dict. snippets tabsheet
</Figure>

Consequently, we receive the following result (Fig. 12).

<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/step_04_3__001.png">
Figure 12: Encoding word class
</Figure>
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/step_04_4__001.png">
Figure 13: Adding gender (part 1)
</Figure>

This will result in the substitution the result of which is displayed in the next illustration (Fig. 14).

<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/step_04_5__001.png">
Figure 14: Adding gender (part 2)
</Figure>
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/step_04_6__001.png">
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/step_04_7__001.png">
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/step_04_8__001.png">
FIgure 17: Etymology
</Figure>
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/step_04_9__001.png">
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/macro_structure_001.png">
Figure 19: Macro structure
</Figure>

We first create an example (Fig. 20).

<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/step_05_1__001.png">
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/step_05_2__001.png">
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/step_05_3__001.png">
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/step_07_1__001.png">
Figure 23: Querying
</Figure>
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/step_07_2__001.png">
...
<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/selecting_element.png">
FIgure 25: Selecting an element
</Figure>

CTRL+F9 will select only the contents of the element (Fig. 26).

<Figure src="/assets/content/resources/creating-lexical-resources-with-tei-enricher/selecting_element_contents.png">
