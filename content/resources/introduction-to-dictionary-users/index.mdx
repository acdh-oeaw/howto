...
<Figure src="/assets/content/resources/introduction-to-dictionary-users/slovarska-raba-in-uporabniske-skupine_eng.png">
Figure 1: Arhar Holdt, Špela, Kosem, Iztok, Gantar, Polona. 2016. Dictionary user typology: The Slovenian Case. p.182. Taken from: [https://euralex.org/wp-content/themes/euralex/proceedings/Euralex%202016/euralex_2016_015_p179.pdf](https://euralex.org/wp-content/themes/euralex/proceedings/Euralex%202016/euralex_2016_015_p179.pdf). Last Access: 13 May 2022
</Figure>
...
<Figure src="/assets/content/resources/introduction-to-dictionary-users/overall-dissimilarity-sl-eu.png">
Figure 2: Overall dissimilarity Slowenian and EU dictionary users
</Figure>
...
<Figure src="/assets/content/resources/introduction-to-dictionary-users/esd-plot-2022-05-12-europe.png">
Figure 3
</Figure>

<Figure src="/assets/content/resources/introduction-to-dictionary-users/esd-plot-2022-05-12-north-macedonia.png">
Figure 4
</Figure>
...
| ------------------------------------------------------------------------------- | -------------------------------------------------------- |
| relatively easy to prepare                                                      | provides limited insight                                 |
| good for large scale studies                                                    | tendency of user overreporting or misreporting           |
| dissemination via the WWW possible (increases potential number of participants) | incomplete answers; users can stop answering at any time |

**interview**

| Advantages                                                               | Shortcomings                                            |
| ------------------------------------------------------------------------ | ------------------------------------------------------- |
| comprehensiveness: good for getting detailed insight into dictionary use | more suitable for small scale studies                   |
| ability to ask users for clarification on their answers                  | a great deal of analysis needed (transcription, coding) |
|                                                                          | good sampling difficult                                 |
|                                                                          | generalisations on smaller groups less reliable         |

**think-aloud protocol**

| Advantages                                       | Shortcomings                                                                |
| ------------------------------------------------ | --------------------------------------------------------------------------- |
| insight into user thinking during dictionary use | suitable only for small scale studies                                       |
|                                                  | a great deal of analysis needed                                             |
|                                                  | findings difficult to generalize                                            |
|                                                  | unnaturalness: user not used to describing their work during dictionary use |
|                                                  | thinking-aloud might increase cognitive effort of participants              |

**eye-tracking**

| Advantages                                                               | Shortcomings                              |
| ------------------------------------------------------------------------ | ----------------------------------------- |
| comprehensiveness: good for getting detailed insight into dictionary use | very invasive                             |
| useful for dictionary design and information placement                   | expensive equipment                       |
|                                                                          | extensive training for researchers needed |
|                                                                          | suitable only for small scale studies     |
|                                                                          | requires experimental design              |
|                                                                          | demanding analysis                        |
|                                                                          | findings might be difficult to generalize |

**user evaluation/feedback**

| Advantages                                | Shortcomings                     |
| ----------------------------------------- | -------------------------------- |
| useful info for a particular dictionary   | limited to a particular resource |
| observations during actual dictionary use | data can be difficult to analyze |
...
| Advantages                                          | Shortcomings                                                                                                                      |
| --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| unobtrusive, no additional effort from users needed | demanding analysis                                                                                                                |
| evidence of actual use                              | difficult to identify context of dictionary use                                                                                   |
|                                                     | findings relevant for a particular resource only                                                                                  |
|                                                     | little control over sample structure (unless users have to register and provide personal info)                                    |
|                                                     | log file data often not available (or very hard to get) for proprietary resources (e.g., dictionaries from commercial publishers) |

**user monitoring**

| Advantages                                | Shortcomings                                   |
| ----------------------------------------- | ---------------------------------------------- |
| monitor actual use during a specific task | findings could be limited to a particular task |
|                                           | more suitable for small-scale studies          |

**language problems (learner corpus analysis, forums etc.)**

| Advantages                                          | Shortcomings                                                             |
| --------------------------------------------------- | ------------------------------------------------------------------------ |
| unobtrusive, no additional effort from users needed | unobtrusive, no additional effort from users needed                      |
| actual language problems                            | evidence of actual use relevance of findings for dictionaries may be low |
...
<Figure src="/assets/content/resources/introduction-to-dictionary-users/table-1-overview.png">
Table 1
</Figure>
