...
summary: Getting access to the data on gitlab.oeaw.ac.at is different on all three operating systems.
tags:
  - data-management
  - git
title: "Git: VS Code"
...
<Tabs>
<Tab title="Windows">
![](/assets/content/resources/git-vs-code/vscode_first_start_windows.png)
</Tab>
<Tab title="MacOS">
![](/assets/content/resources/git-vs-code/vscode-first-start-macos.png)
</Tab>
<Tab title="Linux">
TBD
</Tab>
...
![](/assets/content/resources/git-vs-code/github_clone_repo.png)

<Callout kind="note">
Getting access to the data on https://github.com/acdh-oeaw is different on all three operating systems.
</Callout>
...
![](/assets/content/resources/git-vs-code/githubrepo_clone_from_url.png)

After you hit enter a dialog appears asking you where to store the contents of the repository locally:

![](/assets/content/resources/git-vs-code/clone_select_folder_windows.png)
</Tab>
<Tab title="MacOS">
You can paste the `https://...` of any git repository from a server in the text field that appears when we click `Clone Git repository...` on the start screen of Visual Studio Code:

![](/assets/content/resources/git-vs-code/vscode_getting_started_macos.png)

On MacOS Visual Studio Code asks us for our username and password when we try to clone the repository the first time.

![](/assets/content/resources/git-vs-code/username_password_macos.png)
...
![](/assets/content/resources/git-vs-code/credentials_dialog_windows.png "credentials dialogue Windows")
...
![](/assets/content/resources/git-vs-code/authentication_successful_browser_github.png)
</Tab>
<Tab title="MacOS">
...
![](/assets/content/resources/git-vs-code/sign_in_using_github_macos.png)

This will open a dialog screen on GitHub.com:

![](/assets/content/resources/git-vs-code/github_dialog_authorize.png)

After providing your password the browser asks if it may communicate with Visual Studio Code. Please allow that:

![](/assets/content/resources/git-vs-code/browser_allow_communicate_with_vscode.png)

And also Visual Studio Code asks if it may accept the message from the browser. Please allow that too:

![](/assets/content/resources/git-vs-code/vscode_allow_receive_from_browser.png)
</Tab>
</Tabs>
</Tab>
</Tabs>
...
![](/assets/content/resources/git-vs-code/open_cloned_project.png)
...
![](/assets/content/resources/git-vs-code/trust_authors_windows.png)
...
![](/assets/content/resources/git-vs-code/review_changes.png)
...
![](/assets/content/resources/git-vs-code/stage_change.png)

We put changes in the **staging area**, before we commit.

![](/assets/content/resources/git-vs-code/staged_change.png)
...
![](/assets/content/resources/git-vs-code/commit_message_and_commit_button.png)
...
<Tabs>
<Tab title="Windows">
![First-commit error - windows](/assets/content/resources/git-vs-code/first-commit-error-windows.png)
</Tab>
<Tab title="MacOS">
![First-commit error MacOS](/assets/content/resources/git-vs-code/first-commit-error-macos.png)
</Tab>
<Tab title="Linux">
TBD
</Tab>
...
![](/assets/content/resources/git-vs-code/scroll_up_to_see_tip.png)
...
![](/assets/content/resources/git-vs-code/menu_bar_terminal.png)
...
![](/assets/content/resources/git-vs-code/windows_open_git_bash.png)
</Tab>
<Tab title="MacOS">
### MacOS
...
![](/assets/content/resources/git-vs-code/first_time_terminal_macos.png "first time terminal MacOS")
</Tab>
<Tab title="Linux">
### Linux
...
![](/assets/content/resources/git-vs-code/push.png)
...
![](/assets/content/resources/git-vs-code/credentials_dialog_windows.png)
...
![](/assets/content/resources/git-vs-code/sign_in_using_github_macos.png "sign in using GitHub MacOS")

This will open a dialog screen on GitHub.com:

![](/assets/content/resources/git-vs-code/github_dialog_authorize.png "GitHub dialog authorize")

After providing your password the browser asks if it may communicate with Visual Studio Code. Please allow that:

![](/assets/content/resources/git-vs-code/browser_allow_communicate_with_vscode.png "browser allow communicate with vscode")

And also Visual Studio Code asks if it may accept the message from the browser. Please allow that too:

![](/assets/content/resources/git-vs-code/vscode_allow_receive_from_browser.png "vscode allow receive from browser")
</Tab>
</Tabs>
</Callout>
...
1. If two people edit the same line, then there is a `conflict` that needs to be `resolved.`
...
![](/assets/content/resources/git-vs-code/conflicting_edits.png)
...
![](/assets/content/resources/git-vs-code/accept_current_change.png)

And for example, accept the incoming change.

![](/assets/content/resources/git-vs-code/incorporate_incoming_change.png)

And after resolving **all** the conflicts we do a `merge commit` (the text is there automatically).

![](/assets/content/resources/git-vs-code/commit_merge_to_resolve.png)
