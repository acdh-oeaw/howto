...
---
**This is a blog post series** about SemanticKraus, a research project taking place at the ACDH-CH at the Austrian Academy of Sciences. You can read about it [here](https://www.oeaw.ac.at/acdh/projects/semantickraus) (or in the blogposts to follow). The blog entries to follow here must not (and really cannot) be mistaken for a straightforward progress report, a research paper, or a series of technical instructions. Some of what follows is highly subjective and non-essential. There might be digressions.

Nevertheless, the following is intended as a kind of disclosure of the project process. Our goal is to share experiences on a less formal, sometimes also on a less technical level. Ideally, the ideas and resources provided in these posts will find application elsewhere, in other projects, perhaps inspiring other projects dealing with the same era to also connect their data to the Linked Open Data Cloud.
