...
- Unterscheidung von Unicode & Nicht-Unicode Zeichen
- Definition der Begriffe Text vs. Dokument
- Arbeit mit Faksimiles

## Grundlagen: Texte und ihre Vorlagen
...
Sehr vereinfacht kann man festhalten:
...
Die obenstehende Abbildung zeigt das Zeichen a in unterschiedlichen Schriftarten. Die konkreten und sich unterscheidenden Repräsentationen des Zeichens sind  Glyphen. Eine Zusammenstellung von abstrakten Zeichen, die benötigt werden um Dokumente in einem bestimmten Schriftsystem darzustellen wird als **character set** bezeichnet. Während der Grundbegriff den Zeichensatz in einem Dokument bezeichnet, so wandelt sich der Begriff im Digitalen etwas. Hier wird ein bestimmtes abstraktes Zeichen intern durch einen eindeutigen Code repräsentiert. Deswegen bezeichnet man einen solchen digitalen Zeichensatz auch als **coded character set**. Ein Beispiel hierfür ist Unicode.
...
Aber es gibt in der TEI auch die Möglichkeit, Glyphen und Zeichen zu annotieren, die nicht in Unicode enthalten sind. Mehr dazu in der Praktischen Anwendung.
...
Hier ein Beispiel für eine 'character declaration' und danach für eine Glyphe:
...
Eine gängige Alternative zur direkten Transkription von primären Quellen oder einer anderen Konvertierung in Form von digitalen Zeichen ist die Einbettung derselben in der TEI als Digitalisate der Quelle, für gewöhnlich in Form von Bildern. Diese Art von Ressource wird **digitales Faksimile** genannt, und besteht im einfachsten Fall aus einer Sammlung an Bildern zusammen mit Metadaten, die diese Bilder als Quellenmaterial identifizieren.

Auf das Quellenmaterial kann auf vielfältige Weise innerhalb des TEI-Dokuments Bezug genommen werden und Faksimile werden in digitalen Editionen zumeist parallel zur Transkription eingebunden. Einige Möglichkeiten der Bezugnahme und Annotation zeigt der folgende Abschnitt. 

### Praktische Anwendung

#### Einbindung von Faksimiles und parallele Transkription

Das Element `<facsimile>` ist die vielseitigste Möglichkeit um mit Faksimiles in TEI zu arbeiten. Das Element umschließt die Repräsentation einer Texquelle in Form von Digitalisaten der Primärquelle. Diese wird in einzelne "Oberflächen" also `<surface>`unterteilt (z.B. Seiten eines Dokuments), die benannt werden um später referenziert werden zu können. Diese einzelnen Oberflächen können eine oder mehrere Grafiken mit dem Element `<graphic>`zugewiesen bekommen.
...
<Quiz>
  <Quiz.Card>
    <Quiz.XmlCodeEditor
      code={"<TEI xmlns=\"http://www.tei-c.org/ns/1.0\">\n  <teiHeader>\n    <fileDesc>\n      <titleStmt>\n        <title>Die Filmwelt - ein Ausschnitt</title>\n      </titleStmt>\n      <publicationStmt>\n        <p>Publication Information</p>\n      </publicationStmt>\n      <sourceDesc>\n        <p>Information zur Veröffentlichung</p>\n      </sourceDesc>\n    </fileDesc>\n  </teiHeader>\n  \n  <facsimile>\n    Annotation Facsimiles mit Zonen hier\n  </facsimile>\n  \n  <text>\n    Texttranskription hier\n  </text>\n</TEI>"}
      solution={"<TEI xmlns=\"http://www.tei-c.org/ns/1.0\">\n  <teiHeader>\n    <fileDesc>\n      <titleStmt>\n        <title>Die Filmwelt - ein Ausschnitt</title>\n      </titleStmt>\n      <publicationStmt>\n        <p>Publication Information</p>\n      </publicationStmt>\n      <sourceDesc>\n        <p>Information zur Veröffentlichung</p>\n      </sourceDesc>\n    </fileDesc>\n  </teiHeader>\n  \n  <facsimile>\n    <surface xml:id=\"page11\" ulx=\"0\" uly=\"0\" lrx=\"1081\" lry=\"1457\">\n      <graphic url=\"Filmwelt_1923_31_11.jpg\"/>\n      <zone xml:id=\"zone1\" ulx=\"52\" uly=\"780\" lrx=\"1023\" lry=\"934\">\n      </zone>\n      <zone xml:id=\"zone2\" ulx=\"389\" uly=\"1028\" lrx=\"703\" lry=\"1300\">\n      </zone>\n    </surface>\n  </facsimile>\n\n  <text>\n   <body>\n     <div facs=\"#zone1\">\n       Der Film »Die Wunder des Meeres« läuft ab 14. bis 17. November in: Imperial-Kino, I., Rothgasse 9; Schwarzenberg-Kino,<lb/>\nIII., Schwarzenbergplatz; Flotten-Kino, VI., Mariahilferstraße 85; Wienzeile-Kino, VI., Linke Wienzeile 4; 18. bis 20. November<lb/>\nin: Elite-Kino, I., Wollzeile 34: Opern-Kino, I., Friedrichstraße 4; Zentral-Kino, II., Taborstraße 8b: Dreilaufer Kino, IX., Alser-<lb/>\nstraße; Flieger-Kino, IX., Liechtensteinstraße 36; Wiedner Grand Kino, IV., Mittersteig 15; 21. bis 24. November in: Münstedt-<lb/>\nKino, II., Prater; Joh. Strauß-Kino, IV., Favoritenstraße 12; Raimund-Lichtspiele. XIV., Sechshauserstraße 13; Abbazia-Kino,<lb/>\nXV., Neubaugürtel 15; 25. bis 27. November in: Münstedt-Kino, II., Prater; Luna-Kino, XVII , Hauptstraße 117; Michelbeuern-<lb/>\nKino, XVIII., Kreuzgasse 27; Vindobona-Kino, XX., Wallensteinplatz 5—6. ∆\n     </div>\n      <div facs=\"#zone2\">\n        <lg>\n           <head>Der Filmstar.</head> \n             <l>Du ahnst bei ihm die Schwüle</l> \n             <l>Leise glimmender Gefühle.</l> \n             <l>Steife Hemdbrust —</l> \n             <l>Heben — senken —</l> \n             <l>Augen, die sich stumm verrenken.</l> \n             <l>— — — — — —</l> \n             <l>Er ist von seltner Bescheidenheit.</l> \n             <l>Doch ihn verpflichtet sein Name,</l> \n             <l>Drum kämpft er mit Beharrlichkeit</l> \n             <l>Um jede Großaufnahme.</l> \n             <byline>Friedrich Zelnik.</byline> \n        </lg>\n      </div>\n    </body>\n  </text>\n</TEI>"}
      validate="input"
    >
      <Quiz.Question>
        **Annotieren Sie bitte die im Faksimile von Seite 11 der _Filmwelt_ eingezeichneten Zonen als eine parallele Transkription der Seite.**

        ![](images/filmwelt\_1923\_31\_11\_1080px_zonen.jpeg "Filmwelt 31, 1923, S. 11 - mit zwei eingezeichneten Zonen.")

        Der Dateiname der Grafik lautet "Filmwelt\_1923\_31\_11.jpg".
...
Im TEI-Header wird die rendition wie folgt mittels CSS-Attributen zentral definiert. Dies kann auch komplexer als hier abgebildet werden.
...
Der Einsatz im Text erfolgt als ein Attribut das auf die zentrale Definition im Header referenziert. In diesem Fall wird ein Absatz in diesem Stil ausgezeichnet:
...
Neben Auszeichnungen können auch Umbrüche im Text ausgezeichnet werden, wie z.B. Seitenumbrüche `<pb/>` , Zeilenumbrüche `<lb/>`, und Spaltenumbrüche `<cb/>`.
...
Das vorige Beispiel des ersten Absatzes zum Film "Die Schlacht" wurde hier nun noch einmal um die eingeführten Elemente ergänzt:

```xml
<hi rend="bold">"Die Schlacht."</hi> Nach dem Roman von Claude <lb break="no"/> Farrère wurde dieses Meisterwerk gedreht, ...
```

Und auch zusätzliche gleichbleibende Informations-Elemente auf einer Seite wie beispielsweise Kolumnentitel, Kustoden/Stichworte oder Seitenzahlen können über das Element **'forme work'** `<fw>`  ausgezeichnet werden. Hier einige Beispiele:

- Kolumnentitel: `<fw type="header">…</fw>` 
- Seitenzahl: `<fw type="pageNum">- 11 -</fw>` 
- Kustode / Stichwort: `<fw type="catchword">…</fw>`

Über das Attribut `place` kann angegeben werden, wo die Information auf der Seite platziert ist, z.B.: 

- oben in der Mitte: `place="top-centre"`
- oben rechts: `place="top-right"`
- oben links: `place="top-left"`
- unten in der Mitte: `place="bot-centre"`
- unten rechts: `place="bot-right"`
- unten links: `place="bot-left"`

Mehr Informationen zu diesem Thema gibt es in der [TEI Dokumentation](https://tei-c.org/release/doc/tei-p5-doc/en/html/PH.html#PHSK).
...
<Quiz>
  <Quiz.Card>
    <Quiz.XmlCodeEditor
      ...
      solution={"<xml></xml><TEI xmlns=\"http://www.tei-c.org/ns/1.0\">\n  <teiHeader>\n    <fileDesc>\n      <titleStmt>\n        <title>Die Filmwelt - ein Ausschnitt</title>\n      </titleStmt>\n      <publicationStmt>\n        <p>Publication Information</p>\n      </publicationStmt>\n      <sourceDesc>\n        <p>Information zur Veröffentlichung</p>\n      </sourceDesc>\n    </fileDesc>\n  </teiHeader>\n  <text>\n    <body>\n      Wir bringen die Zusammensetzung des Schiedsrichterkollegiums wie folgt: Josef <hi rend=\"bold\">Rémény</hi>, Direktor der <lb break=\"no\" /> \n      „Mondial“; Otto <hi rend=\"bold\">Kreisler</hi>, Direktor der „Helios“, die Herren Regisseure Hans Karl <hi rend=\"bold\">Breslauer</hi>, Peter <lb break=\"no\" /> \n      Paul <hi rend=\"bold\">Felner</hi> und Hans <hi rend=\"bold\">Otto</hi>; Gustav <hi rend=\"bold\">Körner</hi>, akademischer Maler, Felix <hi rend=\"bold\">Brasch</hi>, Herausgeber der „Film- <lb break=\"yes\"/>\n      welt“, und der Briefkastenonkel der „Fimwelt“. — Die Bilder der von obigem Preisrichterkollegium <lb break=\"no\"/>\n      ausgesuchten schönsten Bewerberinnen werden in Nummer 33 und 34 der „Filmwelt“ veröffentlicht, damit <lb break=\"no\"/>\n      den Lesern und Leserinnen Gelegenheit gegeben wird — mittels Coupon — die endgültige Preisträgerin <lb break=\"no\"/>\n      selbst zu bestimmen.\n    </body>\n  </text>\n</TEI>"}
      validate="input"
    >
      <Quiz.Question>
        **Zeichnen Sie im Inhalt des folgenden Absatzes aus der _Filmwelt_ bitte die Hervorhebungen mithilfe des 'highlighted'-Elements aus. Zeichnen Sie ebenfalls die korrekten Zeilenumbrüche aus, inklusive dem Hinweis, ob es zu einer Wortabteilung kommt.**

        ![](images/Filmwelt\_1923\_31\_12\_Schoenheitskonkurrenz.png "Artikel \"Die Schönheitskonkurrenz\" in Filmwelt 31, 1923, S. 12")
      </Quiz.Question>
    </Quiz.XmlCodeEditor>
  </Quiz.Card>
</Quiz>
...
Gerade wenn man schwerpunktmäßig an der Transkription von originalen, z.T. handschriftlichen, Vorlagen arbeitet, kann es vorkommen, dass Passagen nur schwer leserlich oder gar beschädigt sind. Dies kann auch in der Transkription ausgezeichnet werden.
...
Bei Streichungen von längeren Passagen, ggf. auch mit strukturellen Unterteilungen kommt das Element **'Deleted Span of Text'** `<delSpan>` zum Einsatz. Dieses Element kennzeichnet den Beginn einer Streichung. Den Endpunkt markiert ein Anker `<anchor>` mit einer bestimmten ID, die wiederum im Attribut `spanTo` des `<delSpan>` Elements referenziert wird. Selbiges funktioniert auch für andere Editierungen.

![Hierarchieübergreifende Editierungen](images/delSpan_hierarchieuebergreifend.png "Hierarchieübergreifende Editierungen. Bild: Ulrike Czeitschner, ACDH-CH")
...
Eine **Wiederherstellung**, oder de facto die Rückgängigmachung einer zuvor getätigten Editierung, wird mit dem Element `<restore>` gekennzeichnet.
...
![Beispiel für eine "Metamark"](images/Folie67.png "Beispiel einer für eine \\"Metamark\\". Bild: Text Encoding Initiative, https://www.tei-c.org/release/doc/tei-p5-doc/en/html/PH.html#PH-meta")
