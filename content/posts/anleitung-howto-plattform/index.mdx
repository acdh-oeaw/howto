...
Nun können Sie entweder links unter "Collections" und "Posts" mit dem Button "New Post" einen neuen Beitrag starten oder dies über den Tab "Workflow" tun. Im Bereich "Workflow" finden Sie auch jederzeit alle Beiträge, die derzeit in Bearbeitung sind oder auf ihre Prüfung und Veröffentlichung warten. Wenn Sie also ihre Arbeit unterbrechen, gehen Sie beim nächsten Mal einfach zum Workflow, wo Sie in der ganz linken Spalte unter "Drafts" Ihren Beitrag finden, öffnen und daran weiterarbeiten können. Sobald eine Änderung in einem Beitrag vorgenommen wurde, erinnert Sie die Plattform immer automatisch daran, diese vor dem Verlassen des Beitrags zu speichern (oder ggf. zu verwerfen).
