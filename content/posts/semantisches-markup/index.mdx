...
```
Im folgenden Beispiel sehen Sie die Auszeichnung zweier Spielstätten, in denen der Film _Die Wunder des Meeres_ gezeigt wurde. Wie bereits im vorangegangenen Beispiel wird der Werktitel ausgezeichnet, genauso der Spielzeitraum `<date>`, und die Spielorte. Deren Adresse wird hier genauer in Bezirk `<district>`und Straße `<street>`unterteilt.
...
<p>Der Film <title>»Die Wunder des Meeres«</title> läuft ab <date>14. bis 17. November</date> in:
        ...
        <list>
          <item><orgName>Imperial-Kino</orgName>, <address><district>I.,</district> <street>Rothgasse 9</street></addrLine></address>;</item>
