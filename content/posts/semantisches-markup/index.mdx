...
```
Im folgenden Beispiel sehen Sie die Auszeichnung zweier Spielstätten, in denen der FIlm _Die Wunder des Meeres_ gezeigt wurde. Hier werden der Spielzeitraum `<date>`, 
...
<p>Der Film <title>»Die Wunder des Meeres«</title> läuft ab <date>14. bis 17. November</date> in:
        ...
        <list>
          <item><item><orgName>Imperial-Kino</orgName>, I., Rothgasse 9</addrLine></address>;</item>
