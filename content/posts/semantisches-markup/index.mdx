...
Im folgenden Beispiel finden Sie eine Liste mit Ortsnamen, die in unserem Übungstext aus der *Filmwelt* auftauchen. Es werden nicht nur die Namen, sondern auch die Referenznummern aus der Datenbank [Geonames](http://www.geonames.org/) angegeben, ebenso geographische Angaben wie Kontinent oder ein Ländercode.
