...
```
##### Beispiel 3
Im folgenden Beispiel finden Sie einen kurzen Ausschnitt aus der Rezension des Films _Die Schlacht_. Hier werden ein Ortsname `<placeName>`, Personenname `<persName>`, sowie eine Anapher `<rs>`ausgezeichnet.
