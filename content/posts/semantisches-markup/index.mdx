...
Im folgenden Beispiel sehen Sie einen Nachspann mit kurzen einer Liste historischer Personen. Neben dem Namen wird auch die ID `<xml:id="pe1">`, das Geschlecht, der Beruf, als auch  Geburts- und Sterbeort mit Datum ausgezeichnet.
