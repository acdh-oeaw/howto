...
abstract: 'The resource explores the distinction between the general concept
  vocabularies and controlled vocabularies. Readers learn how a controlled
  vocabulary is used "to organize knowledge for subsequent retrieval" in
  prosopographic data modelling and for which purposes it is utilised. Readers
  can apply tools such as SKOS on sample datasets from the NAMPI and VieCPro
  projects, illustrating the range of potential applications of Linked Open
