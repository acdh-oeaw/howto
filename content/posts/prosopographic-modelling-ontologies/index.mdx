...
* [Tim Berners-Lee, James Hendler and Ora Lassila, The Semantic Web, Scientific American, May 2001, p. 29-37](https://www-sop.inria.fr/acacia/cours/essi2006/Scientific%20American_%20Feature%20Article_%20The%20Semantic%20Web_%20May%202001.pdf) *just 5 pages and freely available*
* [Holger Sistig, semantisches web // semantic web // web 3.0. Informationen zur Zukunft des Internets, website based on diploma thesis of Holger Sistig](https://semantisches-web.net/) (2008). *freely available*
...
* [Harald Sack: Online Lecture. Knowledge Engineerung with Semantic Web Technologies](https://youtu.be/eJ9H1SakPoA) (uploaded 2019), especially: *3.1 Ontology in Philosophy and Computer Science* and *4.2 Web Ontology Language OWL* .
