...
![Overview over *.dmg content](/assets/images/macOS_installerPackage.jpg)
...
![Warning in MacOS - developer not verified.](/assets/images/macOS-warning.png)
If this happens, please press ok and go to your "System Settings" - Security - General. 
![Security settings in MacOS](/assets/images/macOS-securitySettings.jpg)
...
![Installation dialogue for Git.](/assets/images/macOS_installationDialogue.png)
...
[See here why you might want to use VSCodium instead.](vscode_vscodium)
...
The `main` identifier is just a shortcut way to refer to the default timeline (it's actually the default _branch_ of the timeline, because there can be multiple parallel timelines 🤯, we'll have a look at these branches in the second part of this introduction).
