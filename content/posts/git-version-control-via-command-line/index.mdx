...
Resetting history allows to "rewind the clock" to a specific point im time (addressed via unique
...
"rewind the clock" to a specific commit, but nuke any changes that have been made in the project
