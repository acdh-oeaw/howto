...
```bash
C:\User\user_name>cd your_directory
C:\User\user_name\your_directory> cd a_small_folder
C:\User\user_name\your_directory\a_small_folder> cd ..
C:\User\user_name\your directory\ cd ..
C:\User\user_name\
```
</SideNote>
