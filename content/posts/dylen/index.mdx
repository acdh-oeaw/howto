...
Connected words are **semantic neighbours** that share some aspects of the **target word**. Some can even substitute the target word in a particular context. The Ego Network visualizes the **50** most closely related semantic neighbours of a target word. Note that it does not show the target word itself. The semantic neighbours are classified as parts of speech (POS), e.g. noun, proper nouns and verbs. 
