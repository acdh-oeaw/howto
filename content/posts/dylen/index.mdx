...
The Time Series Analysis allows to compare two words over time; the comparison can be relative to first year, last year or previous year.
...
...represents the number of shortest paths that pass through that node. It shows how frequently nodes tand between each other. Again, "Haft" shows more betweenness centrality than "Strafe", meeaning than more shorter paths pass through "Haft".

#### Pagerank

...represents the notion that a nodes is as important as the combined importance of its linked nodes.

#### Clustering coefficient
...measures the degree to which nodes in a graph tend to clulster together.

_The above explanations are taken from the Dylen tool website and can be access and read in more detail via the information button in the node metric analysis visualisation._
</SideNote>
...
In the General Network analysis, the development of speakers or parties can be traced, like the ego network traces individual words. You can visualise your results as a graph on a timeline, or as a table with selected metrics and values.

## Links

[About the Dylen Project]([https://dylen.acdh.oeaw.ac.at/about/](https://dylen.acdh.oeaw.ac.at/about/))
