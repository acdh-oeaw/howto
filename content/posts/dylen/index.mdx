...
Once you clicked on visualise, Dylen will generate your network. Let's stick with our "Geld" (money) example.
...
...represents the number of shortest paths that pass through that node. It shows how frequently nodes tand between each other. Again, "Haft" shows more betweenness centrality than "Strafe", meaning than more shorter paths pass through "Haft".
