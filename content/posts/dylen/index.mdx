...
...represents how connected a word is. It shows the total number of edges linked to a node. In the example, "Haft" has a higher degree centrality than Strafe, meaning that it is better connected.

#### Betweenness centrality

...represents the number of shortest paths that pass through that node. It shows how frequently nodes tand between each other
</SideNote>
