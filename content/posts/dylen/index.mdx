...
There are two types of General Networks: here you can find the whole speech of a particular political party (General Network Party) or politician (General Network Speaker). Since the volume of these networks is considerable, the node filter is required to specify the percentage of nodes that you need displayed. This network type allows you to explore lexemes used by individual speakers in the Austrian Parliament.
