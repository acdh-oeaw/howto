...
Go to the VOICE 3.0 interface and answer the following four questions. Please note that the four questions build on each other, so do not delete your filters in-between.
