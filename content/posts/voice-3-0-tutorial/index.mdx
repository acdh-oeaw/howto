...
![](images/voice3-0_filter_grey_highlighted.png "Picture: Search results for corpus and subcorpus, with opened transcript on the right-hand side")
...
![](images/voice3-0_filters_manually.png "Picture: Manual selection")
</SideNote>
...
![](images/voice3-0_bookmark_export.png "Picture: Working with bookmarks")
