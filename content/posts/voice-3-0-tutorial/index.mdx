...
In VOICE 3.0 Online, users have the possibility to create their own sub-corpora by applying filters, and bookmark their search results, which they can subsequently export and import.
