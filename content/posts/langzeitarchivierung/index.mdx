...
<Quiz>
  ...
  <Quiz.Card>
    <Quiz.MultipleChoice>
      <Quiz.Question>
        Mit welcher Lizenz ist die Datenbank "Human Rights Uses Consensus", die man in DANS finden kann, versehen?
      </Quiz.Question>
...
<Quiz>
  <Quiz.Card>
    <Quiz.MultipleChoice>
      <Quiz.Question>
        Sie möchten gerne die Datensammlung "CoReMa" aus der GAMS zitieren. Wo finden Sie die notwendigen bibliographischen Angaben?
      </Quiz.Question>
  ...
  <Quiz.Card>
    <Quiz.MultipleChoice>
      <Quiz.Question>
        Dürfen Sie die mitteralterlichen Rezepte aus "CoReMa" weiterverwenden und z.B. auf Ihrer eigenen Projektseite veröffentlichen? (Mehrfachantwort)
      </Quiz.Question>

      <Quiz.MultipleChoice.Option>
        Sowohl die Texte als auch alle in der GAMS vorliegenden Faksimilies dürfen uneingeschränkt und sofort weiterverwendet werden.
      </Quiz.MultipleChoice.Option>

      <Quiz.MultipleChoice.Option isCorrect>
        Bei den Bildern ist vorab zu prüfen, welche Lizenz die Besitzer der Originalobjekte dafür vorgesehen und vergeben haben.
      </Quiz.MultipleChoice.Option>
...
**Quiz zur ACHE des ACDH-CH:**

<Quiz>
  <Quiz.Card>
    <Quiz.MultipleChoice>
      <Quiz.Question>
        Welche Linzenzmodelle werden bei ARCHE für eingereichte Daten bevorzugt?
      </Quiz.Question>
      ...
      <Quiz.MultipleChoice.Option>
        Da Forschungsdaten eine_n Urheber_in haben und nicht verändert werden sollten, können diese nur mit der Lizenz CC-BY-NC-SA im Archiv hinterlegt werden.
      </Quiz.MultipleChoice.Option>
  ...
  <Quiz.Card>
    <Quiz.MultipleChoice>
      <Quiz.Question>
        Was ist eine PID, die bei ARCHE für digitale Objekte  vergeben wird?
      </Quiz.Question>
      ...
      <Quiz.MultipleChoice.Option>
        PID steht für Personal Identification Number, die jede_r Autor_in bei ARCHE bei der ersten Registrierung zugewiesen bekommt.
      </Quiz.MultipleChoice.Option>
...
**Quiz zum Swedish National Dataservice:**

<Quiz>
  <Quiz.Card>
    <Quiz.MultipleChoice>
      <Quiz.Question>
        Das SND nutzt unterschiedliche Symbole, um die Zugänglichkeit der enthaltenen Datenbanken zu kennzeichnen. Welches Symbol zeigt Ihnen an, dass die Daten frei zugänglich sind?
      </Quiz.Question>
  ...
  <Quiz.Card>
    <Quiz.MultipleChoice>
      <Quiz.Question>
        Welches der vorher vorgestellten Archive bietet genauso wie die SND die Möglichkeit an, CLARIN Virtual Collection Registry zu nutzen?
      </Quiz.Question>
...
**Quiz zum Archiv Zenodo:**

<Quiz>
  <Quiz.Card>
    <Quiz.MultipleChoice>
      <Quiz.Question>
        Was unterscheidet Zenodo von den anderen vorgestellten Beispielen von Datensammlungen? (Mehrfachantwort)
      </Quiz.Question>
...
![ARCHE - Deposition Process](images/arche_depositionprocess-crop.png "ARCHE - Deposition Process, CC-BY-4.0 (https://creativecommons.org/licenses/by/4.0).")
...
**Quiz zu den Praxishinweisen Langzeitarchvierung:**

<Quiz>
  <Quiz.Card>
    <Quiz.MultipleChoice>
      <Quiz.Question>
        Für Ihr Forschungsprojekt über die eierlegende Wollmilchsau und verschiedene Enten (siehe das Übungsbeispiel zu "Grundlagen des Datenmanagements") haben Sie eine Reihe von historischen Bildern digitalisiert und wollen diese Bildersammlung nun in einem Archiv sichern. Sie haben sich für das Archiv SND entschieden. In welchem Dateiformat sollten Sie die Bilder präferiert abspeichern, damit diese dort archiviert werden?
      </Quiz.Question>
  ...
  <Quiz.Card>
    <Quiz.MultipleChoice>
      <Quiz.Question>
        Sie benötigen für die Archivierung Ihrer Bildersammlung noch eine Lizenz – die einzige Bedingung, die Sie an die Lizenz stellen, ist, dass der Urheber/die Urheberin bei einer Weiternutzung des Bildes genannt wird. Welche Lizenz ist daher zu wählen?
      </Quiz.Question>
