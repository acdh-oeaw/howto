...
![Diagramm des funktionellen Modells von OAIS](images/oais_functional_model_-en-_wikimediacommons.svg "Diagramm des funktionellen Modells von OAIS. Quelle: Wikimedia Commons, CC BY-SA 3.0. (Siehe: https://creativecommons.org/licenses/by-sa/3.0).")
...
![Lebenszyklus der Daten](images/datalifecycle.png "'DataLifeCycle', von Martina Trognitz ist lizenziert unter CC-BY 4.0. Die Abbildung basiert auf dem IANUS Lebenszyklus und dem Zyklus des UK Data Service. (Siehe: https://creativecommons.org/licenses/by/4.0).")
