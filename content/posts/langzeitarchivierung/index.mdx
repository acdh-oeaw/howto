...
**Vertiefende Fragen zum GAMS:**

<Quiz>
  <Quiz.Card>
    <Quiz.MultipleChoice>
      <Quiz.Question>
        Sie möchten gerne die Datensammlung "CoReMa" aus der GAMS zitieren. Wo finden Sie die notwendigen bibliographischen Angaben auf der Website?
      </Quiz.Question>
...
**Vertiefende Fragen zur ACHE des ACDH-CH:**
...
<Quiz>
  ...
  <Quiz.Card>
    <Quiz.MultipleChoice>
      <Quiz.Question>
        Was ist laut den FAQs auf der ARCHE-Website die PID, die für digitale Objekte bei ARCHE vergeben wird?
      </Quiz.Question>
...
**Übung zum Abschnitt "Praxishinweise für Langzeitarchvierung":**

<Quiz>
  <Quiz.Card>
    <Quiz.MultipleChoice>
      <Quiz.Question>
        Für Ihr Forschungsprojekt über die eierlegende Wollmilchsau und verschiedene Enten (siehe das Übungsbeispiel zu "Grundlagen des Datenmanagements") haben Sie eine Reihe von historischen Bildern digitalisiert. Sie wollen diese Bildersammlung nun in einem Archiv sichern. Sie haben sich für das Archiv SND entschieden. In welchem Dateiformat sollten Sie die Bilder präferiert abspeichern, damit diese dort archiviert werden?
      </Quiz.Question>
