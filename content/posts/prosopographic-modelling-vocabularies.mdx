...
tags:
  - prosopographic-data
  - semantic-web
abstract: Prosopographic data modelling, vocabularies
licence: ccby-4.0
toc: true
...
One central controlled vocabulary in _VieCPro_ categorizes the functions/roles/occupations (Funktionsbezeichnungen) at the Viennese Court (see: [viecpro-vocabs.skos.ttl](/assets/cms/documents/posts/prosopographic-modelling-vocabularies/viecpro-vocabs.skos.ttl)).
...
Closely corresponding to the Funktionsbezeichnung of _VieCPro_, in _NAMPI_ there is a classification of religious status and occupation. However, partly owing to the factoid-based data model, it is not represented as skos:Concepts, but rather as subClass hierarchy of the generic concept `Aspect`, defined in the dedicated [monastic-life ontology](/assets/cms/documents/posts/prosopographic-modelling-vocabularies/monastic-life.owl):

![nampiVisual](/assets/cms/images/posts/prosopographic-modelling-vocabularies/nampiVisual.jpg)
...
For the purpose of this exercise we've derived a controlled vocabulary from the original data in SKOS (see: [nampiSkos.ttl](/assets/cms/documents/posts/prosopographic-modelling-vocabularies/nampiSkos.ttl))
...
- Example from NAMPI:
  ...
  ![Usage Example NAMPI](/assets/cms/images/posts/prosopographic-modelling-vocabularies/UsageExample_Nampi_Carthusianprior.png)
...
- Example from VieCPro:
  ...
  ![Usage Example VieCPro](/assets/cms/images/posts/prosopographic-modelling-vocabularies/UsageExample_ViecPro_Kammerkoechin.png)
