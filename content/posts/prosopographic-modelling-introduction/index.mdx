...
abstract: "In the following HowTo, you will familiarise yourself with the basic
  terminology used in prosopographic data modelling and Semantic Web, in
  relation to the projects NAMPI and VieCPro. These main concepts are
  introduced: ontologies, vocabularies, RDF (Resource Description Framework),
  OWL (Web Ontology Language), SKOS (Simple Knowledge Organisation System),
  SPARQL (SPARQL Protocol and RDF Query Language), LOD (Linked Open Data) and
  LOD-cloud."
licence: ccby-4.0
toc: true
