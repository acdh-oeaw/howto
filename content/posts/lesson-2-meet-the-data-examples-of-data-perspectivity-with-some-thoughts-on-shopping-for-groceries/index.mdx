...
Now, where some might see a nightmare of endless integration problems, others see a task cut out perfectly for a modeling based on an ontology with as wide a scope as CIDOC crm (which will serve as the main vocabulary for our data model).
