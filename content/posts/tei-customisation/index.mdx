...
In TEI finden sich über 500 Elemente. Zur besseren Übersicht und Verständlichkeit wurden die Elemente klassifiziert, wobei es zwei verschiedene Möglichkeiten des Ausdruck von Gemeinsamkeiten gibt: entweder teilen Elemente dieselben Attribute, oder aber die Elemente kommen im _content model_ am selben Ort in der Texthierarchie vor. Ein Element "erbt" auch die Eigenschaften der Klassen, in die es eingebettet ist, da durch die hierarchische Struktur der TEI auch Über- und Unterklassen entstehen.

**Attributklassen** (_[attribute class](https://www.tei-c.org/release/doc/tei-p5-doc/en/html/ST.html#STECAT)_): Gruppierung ähnliche Attribute (z.B. `<att.typed>`)
