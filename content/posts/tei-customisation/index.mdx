...
Im `<back>` zu _Die Filmwelt_ werden zwei Personenregister festgelegt; ein historisches und ein fiktionales. Damit die darin vorgenommenen Auszeichnung oder fehlenden Auszeichnungen valide sind, müssen sie bestimmte Annahmen erfüllen:
...
Im Odd Dokument wird nicht nur die formale Deklaration vorgenommen, sondern auch durch für Menschen lesbar eindeutig beschrieben wird, was die gesetzte Regel bedeutet. Zusätzlich könnte auch ein Beispiel angegeben werden, um die Regel zu veranschaulichen.
