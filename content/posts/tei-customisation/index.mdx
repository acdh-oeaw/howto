...
`<moduleRef>` nimmt eine Sonderstelluung ein, weil hier entweder durch _url_ auf ein externes Schema in der RelaxNG Sprache verwiesen wird (so kann auf Schemata, die nicht aus TEI stammen, verwiesen werden), oder durch _key_ auf bereits vorhandene TEI Module.
