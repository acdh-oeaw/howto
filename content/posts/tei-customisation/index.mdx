...
<Quiz>
  <Quiz.Card>
    <Quiz.MultipleChoice>
      ...
      <Quiz.MultipleChoice.Option isCorrect>
        <valItem ident="historical"><desc>Register historischer Personen</desc></valItem>
      </Quiz.MultipleChoice.Option>

      <Quiz.MultipleChoice.Option>
        <valItem ident="historical"><desc>Register fiktionaler Personen</desc></valItem>
      </Quiz.MultipleChoice.Option>

      <Quiz.MultipleChoice.Option>
        <valItem ident="fictional"><desc>Register fiktionaler Personen</desc></valItem>
      </Quiz.MultipleChoice.Option>
