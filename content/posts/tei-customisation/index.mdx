...
- **Corpus**: Dieses Schema eignet sich für die Auszeichnung von unterschiedlichsten Sprachkorpora. Man findet hier unter anderem Komponenten, mit denen man kontextuelle Informationen, aber auch linguistische Informationen auszeichnen kann.
