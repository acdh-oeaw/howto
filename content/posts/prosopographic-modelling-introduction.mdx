...
tags:
  - prosopographic-data
  - semantic-web
abstract: Prosopographic data modelling, introduction and terminology
licence: ccby-4.0
toc: true
...
![The anatomy of a SPARQL query](/assets/cms/images/posts/prosopographic-modelling-introduction/sparql_anatomy.png)
...
![Four types of SPARQL queries](/assets/cms/images/posts/prosopographic-modelling-introduction/sparql_four_types.png)
