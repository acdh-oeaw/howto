---
title: Introduction HowTo Platform
lang: en
...
<SideNote type="note">
The following paragraphs show the creation of content based on an idea. If a draft, an edited text or practice materials have already been created, you can skip directly to the paragraph “How to publish an article?”.
</SideNote>
...
5. **Check available documents and materials and collect ideas for exercises**: Do you already have notes, text elements or rough drafts of your topic? Oftentimes short texts that lend themselves well to expand on have already been created by colleagues (or oneself) at an earlier stage. Collect all available materials and structure them into chapters. Do the same with ideas for exercises or examples – check what is available and where it could be included. Think about where an(other) exercise, question or a short quiz could be integrated. You can also get inspiration from other articles or reach out to the editorial team – we can help you with the implementation.
...
![](images/aa2380be-ed1f-41da-9040-0800e5d86dbd.png "Screenshot: Title and URL after first save")
...
![](images/70cc7f61-323c-49f7-b742-c583b51cbe02.png "Screenshot: Editing tools in CMS")
