...
<SideNote type="note">
Posts are always saved as drafts first. Once you have finished your article, you can change the draft to “In Review”, and the editorial team will then check it. Once this has been done, the article will be set to “Ready” and subsequently published. Only after the publication, it is visible on the front end of the Learning Resources Platform.
