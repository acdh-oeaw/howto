...
<SideNote type="note">
The following paragraph shows the creation of content based on an idea. If a draft, an edited text or practice materials have already been created, you can skip directly to the paragraph “How can I publish an article?”.
</SideNote>
