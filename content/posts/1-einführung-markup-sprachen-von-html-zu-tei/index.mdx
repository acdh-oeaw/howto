...
tags:
  - tei
  - xml
abstract: Dieses Kapitel gibt einen Überblick über den Digitalisierungsprozess und die Markup-Sprachen HTML und XML und stellt grundlegende Eigenschaften von TEI vor.
licence: ccby-4.0
toc: true
...
<Quiz>
  <Quiz.Card>
    <Quiz.MultipleChoice>
      ...
      <Quiz.MultipleChoice.Option>
        HTML bildet die Grundlage für spezifische Markup-Sprachen wie TEI und MEI.
      </Quiz.MultipleChoice.Option>
...
- Ein Personenname kann nur _innerhalb_ einer Überschrift, eines Paragraphen oder einer Verszeile vorkommen, aber niemals außerhalb.
...
![XML Hierarchie eines Buches](images/xmlhierarchiebuch.png "XML-Struktur eines Buches. Bild: Ulrike Czeitschner, ACDH-CH")
