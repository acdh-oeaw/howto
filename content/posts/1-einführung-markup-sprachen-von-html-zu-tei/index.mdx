...
Die Bezeichnung von XML als Markup Language ist leider nicht sehr präzise gewählt, wenn nicht sogar irreführend. Denn XML  definiert keine Elemente. Es stellt vielmehr ein Regelwerk für den Entwurf von konkreten Auszeichnungssprachen und ihren Anwendungen dar und wird deshalb auch als Metasprache bezeichnet, die unbegrenzt erweiterbar ist. Das bedeutet, dass sich mit XML beliebig viele unterschiedliche Sprachen definieren lassen, die jeweils ganz unterschiedliche Zwecke verfolgen können. Die (Meta-)Sprache selbst ist leicht verständlich, da sie nicht aus abstrakten Codes, sondern aus Text besteht, was den Vorteil hat, dass sie von Mensch und Maschine gelesen werden kann. Dies ist neben der Plattformunabhängigkeit und der Erweiterbarkeit mit ein Grund für die weite Verbreitung und den Erfolg von XML.
