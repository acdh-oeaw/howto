...
See our GIT collaboration guide to learn more about [cloning a remote repository](https://howto.acdh.oeaw.ac.at/de/resource/posts#cloning-a-remote-repository).
...
See our GIT version control via command line guide to learn more about [adding files](https://howto.acdh.oeaw.ac.at/de/resource/posts#mark-content-changes-to-be-included-in-the-version-history).
...
See our GIT version control via command line guide to learn more about [bundle changes into meaningful chunks and commit to them](https://howto.acdh.oeaw.ac.at/de/resource/posts#bundle-changes-into-meaningful-chunks).
