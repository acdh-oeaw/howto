...
VS Code and VSCodium are examples for code editors. Using the command line or terminal instead has
...
`GitHub CLI`. We need the HTTPS option. On the right there is a copy to the clipboard button we can use.
