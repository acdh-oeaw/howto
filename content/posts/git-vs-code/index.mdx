...
tags:
  - datenmanagement
abstract: Getting access to the data on gitlab.oeaw.ac.at is different on all
...
<SideNote type="info" title="It's time to start Visual Studio Code">
  <Tabs>
    <Tab title="Windows">
      Open (Visual Studio) Code or VS(Codium) from the start menu. You can just open it and start typing Code or VS.

      ![start VSCodium Windows](images/start_VSCodium_Windows.png "start VSCodium Windows")

      You can either read and follwo the tips and customize the appearance or click on `🡰 Get Started`.

      ![VSCodium getting started](images/VSCodium_getting_started.png "VSCodium getting started")

    </Tab>
    <Tab title="MacOS">
      Open Visual Studio Code or VSCodium from your application folder.

      ![start Visual Studio Code MacOS](images/start_VSCode_MacOS.png "start Visual Studio Code MacOSs")

      You can either read and follwo the tips and customize the appearance or click on `🡰 Get Started`.

      ![Visual Studio Code getting started MacOS](images/VSCode_getting_started_MacOS.png "Visual Studio Code getting started MacOS")
    </Tab>
    <Tab title="Linux">
  ...
  <Tabs>
    ...
    <Tab title="MacOS">
      ...
      Studio Code. Please allow that:
			...
			![](images/vscode_allow_receive_from_browser.png "vs code allow receive from browser")
    </Tab>
...
![](images/commit_message_and_commit_button.png "Commit message and commit button")
...
<SideNote type="info" title="Unfortunately this differs again between the three OS">
<Tabs>
<Tab title="Windows">
### Windows
