...
![](images/credentials_dialog_windows.png "Github authentication") We recommend to
`Sign in with your browser`. A browser window will open for you to log in to github. Once you're
...
howto_trainingmaterials, let's open the `teapot.mdx` in Visual Studio Code. This is done while the
...
`You drink tea every day` at the end.
...
suggested `git config` commands with your own details and execute them in a terminal. Visual Studio
Code provides one. So click on "Terminal" at the bottom right.
