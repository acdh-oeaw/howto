...
![VS Code first start - Windows](images/vscode_first_start_windows.png "VS Code first start")

</Tab>
<Tab title="MacOS">

![VS Code first start - MacOS](images/vscode-first-start-macos.png "VS Code first start")
<Tabs />
...
when we click `Clone Git repository...` on the start screen of Visual Studio Code.
...
![First-commit error - windows](images/first-commit-error-windows.png "First-commit error")

</Tab>
<Tab title="MacOS">
![First-commit error MacOS](images/first-commit-error-macos.png "First-commit error")
...
<SideNote type="info" title="Unfortunately this differs again between the three operating systems">
<Tabs>
<Tab title="Windows">
### Windows
