...
![start VSCodium Windows](/assets/images/start_VSCodium_Windows.png "start VSCodium Windows")
You can either read and follow the tips and customize the appearance or click on `🡰 Get Started`.
![VSCodium getting started](/assets/images/VSCodium_getting_started.png "VSCodium getting started")

### MacOS

Open Visual Studio Code or VSCodium from your application folder.
![start Visual Studio Code MacOS](/assets/images/start_VSCode_MacOS.png "start Visual Studio Code MacOSs")
You can either read and follow the tips and customize the appearance or click on `🡰 Get Started`.
![Visual Studio Code getting started MacOS](/assets/images/VSCode_getting_started_MacOS.png "Visual Studio Code getting started MacOS")
