...
<SideNote type="info">
  ...
  ![](images/credentials_dialog_windows.png "Github authentication") We recommend to `Sign in with
  your browser`. A browser window will open for you to log in to github. Once you're successfully
  authenticated, you can close the browser window.
  ![](images/authentication_successful_browser_github.png "Authentication successful")
</SideNote>
