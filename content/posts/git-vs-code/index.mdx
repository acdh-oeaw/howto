...
For example we want to clone `wboe-artikel` from [https://gitlab.oeaw.ac.at/acdh-ch/wboe](https://gitlab.oeaw.ac.at/acdh-ch/wboe).
The data at this location, in this repository, is marked as private. So you need to log into [gitlab.oeaw.ac.at](https://gitlab.oeaw.ac.at) with the account you set up to see the contents.
