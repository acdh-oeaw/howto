...
Die Inhalte des Kapitels beruhen auf dem Impulsvortrag "Grundlagen des Datenmanagements" der Tool Gallery 7.2. (November 2021) des ACDH-CH, dessen Aufzeichnung (Deutsch) auf Youtube verfügbar ist.
</SideNote>

<Video provider="youtube" id="71iJpKCVOOs" caption="Aufzeichnung des Impulsvortrags von Martina Trognitz zu den Grundlagen des Datenmanagements bei der Tool Gallery 7.2. am 16. November 2021." startTime="208" />
...
![](images/datalifecycle.png "Abbildung: DataLifeCycle, von Martina Trognitz, ist lizenziert unter CC-BY 4.0 (https://creativecommons.org/licenses/by/4.0/). Die Abbildung basiert auf dem IANUS Lebenszyklus und dem Zyklus des UK Data Service.")
...
![](images/lost_data_map_rfii_mau_cc-by.png "Abbildung: Lost Data Map, von Franziska Mau, FranziMachtDas.de, ist lizenziert unter CC BY-SA (https://creativecommons.org/licenses/by-sa/4.0/).")
...
![](images/protip_never_look_into_someone_elses_documents_folder.png "Abbildung: Protip: Never look in someone else's documents folder, von Randall Munroe, xkcd.com, ist lizenziert unter CC-BY-NC 2.5 (https://creativecommons.org/licenses/by-nc/2.5/).")
...
- **Sort** – zuerst die Ordner und Dateien **sichten**: alle Dateien darauf kontrollieren, ob überflüssige (z.B. doppelte) Dateien entfernt werden können. Falls man sich nicht sicher ist, ob eine Löschung wirklich durchgeführt werden sollte, kann ein Ordner „vorgesehenZurLoeschung“ oder einen „Dachboden“ (Attic) für diese Dateien anlegen. In diesem Ordner sollte dann nicht mehr produktiv gearbeitet werden, er dient lediglich der Aufbewahrung vor einer möglichen Löschung. Wenn darin enthaltene Dateien doch noch bearbeitet werden sollen, müssen sie in einen anderen Ordner verschoben werden.
...
- CESSDA Training. _[Data Management Expert Guide.](https://www.cessda.eu/Training/Training-Resources/Library/Data-Management-Expert-Guide)_ CESSDA ERIC, 2017-2020.
- Fuchs, Siiri: "[How do I use 5S method for organizing data files?](https://blogs.helsinki.fi/thinkopen/5s-method/)" In: _Think Open Blog_. Helsinki, 2019.
- Trognitz, Martina, Felix Schäfer, Reiner Göldner, und Thomas Schenk. ["Dateiverwaltung."](https://ianus-fdz.de/it-empfehlungen/dateiverwaltung) _IANUS_, 18.11.2017.
...
![](images/versionierungselemente.png "Abbildung: Versionierungselemente, von Martina Trognitz, ist lizenziert unter CC-BY 4.0 (https://creativecommons.org/licenses/by/4.0/).")
...
- Trognitz, Martina. ["Textdokumente."](https://ianus-fdz.de/it-empfehlungen/textdokumente#text-kodierung) _IANUS_, 4.4.2016.
...
<SideNote type="info" title="Hinweis:">
Mehr zur Nutzung von Metadaten erfahren Sie im HowTo Kapitel "Metadaten und Dokumentation" von Daniel Schopper. Hier auch verfügbar als [Videoaufzeichnung](https://www.youtube.com/watch?v=gSpzRK7ujp0) (Vortrag bei der Tool Gallery 7.2. am 17. November 2021).
</SideNote>
...
<SideNote type="tip" title="Tipp: Praktische Übung">
Gehen Sie anschließend zum Kapitel "Datenmanagement - Übungen". In diesem Abschnitt haben wir eine Übung vorbereitet, mit der die hier präsentierten Grundlagen und Regeln des Datenmanagements gleich praktisch erprobt werden können. Viel Erfolg!
</SideNote>