...
![](images/datalifecycle.png "Abbildung: DataLifeCycle, von Martina Trognitz, ist lizenziert unter CC-BY 4.0 (siehe: https://creativecommons.org). Die Abbildung basiert auf dem IANUS Lebenszyklus und dem Zyklus des UK Data Service.")
...
![](images/lost_data_map_rfii_mau_cc-by.png "Abbildung: Lost Data Map, von Franziska Mau, FranziMachtDas.de, ist lizenziert unter CC BY-SA (siehe: https://creativecommons.org)..")
...
![](images/protip_never_look_into_someone_elses_documents_folder.png "Abbildung: Protip: Never look in someone else's documents folder, von Randall Munroe, xkcd.com, ist lizenziert unter CC-BY-NC 2.5 (siehe: https://creativecommons.org).")
...
![](images/versionierungselemente.png "Abbildung: Versionierungselemente, von Martina Trognitz, ist lizenziert unter CC-BY 4.0 (siehe: https://creativecommons.org).")
