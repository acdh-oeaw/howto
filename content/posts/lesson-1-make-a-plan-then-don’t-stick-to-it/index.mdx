...
_(Upon asking, it turns out they could they could: Martin tells me that he would very much welcome people approaching him on a matter like this. Also, PMB – the underlying system as well as its contents – is open source, so anyone can use its API or set it up themselves, provided they have the technical skills.)_
