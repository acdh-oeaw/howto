...
### 1a) Location-Referenced Intern

Im Vergleich zur Option **1a** wird in der Variante `method="location-referenced" location="internal/"` der Apparat direkt im Textkörper wiedergegeben. Wie Sie im Beispiel sehen, wird im Element `<app>` direkt an dem Ort, wo sich die unterschiedliche Lesart `<rdg>`in einem anderen Textzeugen `wit="#C"` findet, angegeben.
