...
![Verbindung von Text & Apparat (3), double end-point attachment: extern](images/textkrit_verbindung_loc_ext.png "Verbindung von Text & Apparat (3), double end-point attachment: extern")

### 2b) Double End-Point Attachment: Intern

Bei der internen Variate wird der Apparat nicht vom Text getrennt, sondern ebenfalls im `<body>` dargestellt.
