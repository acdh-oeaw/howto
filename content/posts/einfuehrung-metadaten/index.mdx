...
Wir haben zum einen ein Objekt aus der Arche mit einer bestimmten Nummer (111841) als Subjekt. `arche:` ist der Platzhalter für einen Identifikator, der im Präfix genauer definiert wird. Dieses Objekt hat mehrere Eigenschaften, die in den Prädikaten definiert werden: 
...
Für die Ausformung dieser Aussagen in RDF gibt es unterschiedliche Syntax-Formen: [XML](https://www.w3schools.com/xml/xml_rdf.asp), [JSONLD](https://json-ld.org/) oder [TTL (Turtle)](https://www.w3.org/TR/turtle/) - eine menschenlesbare, kurze Form, die auch im obigen Beispiel verwendet wurde. 
