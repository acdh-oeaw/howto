...
Der zweite große Bereich, wie man Werte in Datenfeldern einschränken bzw. vordefinieren kann, sind kontrollierte Vokabularien. Bekannte Beispiele sind [Getty AAT](https://www.getty.edu/research/tools/vocabularies/aat/) (Art & Architecture Thesaurus) oder [DARIAH BBT](https://vocabs.dariah.eu/bbt/en/) (Backbone Thesaurus). Diese Vokabularien sind hierarchisch oder orthogonal organisiert und definieren die Bedeutung von Begriffen. Denn um klar zu definieren was mit einem bestimmten Wert gemeint ist, muss dieser kontrolliert verwendet werden. Zu diesem Zweck gibt es im Bereich der Metadaten das System [SKOS - Simple Knowledge Organization](https://www.w3.org/2004/02/skos/) - mit dem man solche Thesauri – also kontrollierte Vokabularien - aufbauen und miteinander in Verbindung setzen kann. Verbindungen können beispielsweise über das Mapping von gleichen oder ähnlichen Begriffen in Konzept-Schemata erfolgen. Die Syntax hierfür ist: 

`skos:closeMatch ` bzw.  `skos:exactMatch`
...
Der dritte Bereich sind die Persistent Identifier. Diese sind entsprechend also auf der infrastrukturellen Seite angesiedelt.   
