...
- **Name bzw. Nummerierung**, `@n`: Mit diesem Attribut werden häufig Aufzählungen gekennzeichnet. Dieses Element kann mehrfach mit derselben Bezeichnung in einem Dokument vorkommen und jedes Zeichen ist zulässig.
