...
tags:
  - xml
  - tei
abstract: In diesem Modul erfahren Sie mehr über den sogenannten Body, den
  Bereich Ihres Dokuments, in dem sich der Text befindet, den Sie annotieren
  (ohne Vor- und Nachspann). Die Textstruktur wird besprochen, genauso die
  Auszeichnung durch Elemente und Attribute.
licence: ccby-4.0
toc: true
