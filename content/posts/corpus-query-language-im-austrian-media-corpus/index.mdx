...
![Beispielhaftes Abfrageergebnis zur CQL-Abfrage `[posTT="ADJA"] [lemma="Haus"]`. Links oben sehen Sie die Suchabfrage und die Anzahl der gefundenen Ergebnisse. Mittig finden Sie die ersten Suchergebnisse. Sie sehen in rot die gefundenen Formen im Text, in grau darunter das jeweilige Lemma.](images/amc_3.1_concord_cql_postt_adja_lemma_haus_research_result_dec22_boxes.png "Beispielhaftes Abfrageergebnis zur CQL Abfrage `[posTT="ADJA"] [lemma="Haus"]`. Links oben sehen Sie die Suchabfrage und die Anzahl der gefundenen Ergebnisse. Mittig finden Sie die ersten Suchergebnisse: in rot die gefundenen Formen, in grau darunter das jeweilige Lemma.")
