...
<Quiz>
  ...
  <Quiz.Card>
    <Quiz.MultipleChoice variant="single">
      ...
      <Quiz.MultipleChoice.Option>
        Aufgrund des logischen ODER können mur Treffer gefunden werden, die entweder das Wort "klima" beinhalten ODER aber Nomen sind. Bei zwei ausschließenden Kriterien wird immer nur das erste Kriterium unbedingt erfüllt.
      </Quiz.MultipleChoice.Option>
...
- \[word="ein"] \[pos="ADJ.\*"]\* \[word="Haus"] findet „ein“ und „Haus“ mit _beliebig vielen optionalen_ Adjektiven dazwischen: ein Haus, ein schönes Haus, ein schönes großes Haus, …
