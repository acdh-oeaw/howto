...
<SideNote type="info" title="Info: Detailierte Dokumentation _aller_ Attribute im amc">
Die oben angeführte Vertikale sowie die Beispiele in diesem Tutorial verwenden nur einen Auszug der tatsächlich im amc verfügbaren Informationen. Auf der amc-site findet sich die detaillierte **[Beschreibung aller im amc verwendeten Annotationen](https://amc.acdh.oeaw.ac.at/dokumentation/korpusinhalt-attribute/)**.  
</SideNote>
