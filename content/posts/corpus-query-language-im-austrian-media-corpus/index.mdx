...
- _pos_ : part-of-Speech tags, wie sie vom PoS tagger RFTagger vergeben wurden: zusätzlich zur Wortart werden auch morphologische Informationen angegeben.
  ...
  ![](images/amc3.2_concordance_lemma_noun_ciao_random_result_postt-annotation.png "Es wurden die Attribute word, lemma, posTT, und pos ausgewählt. Die Information ist unter dem Token ciao sichtbar.")
- Wieder Text

<SideNote type="tip" title="Tipp: Attribute eines Korpus">
Die Liste aller Attribute eines Korpus lässt sich immer einfach unter dem Menüpunkt _Corpus info_ oder auch — völlig äquivalent — durch Anklicken des Korpusnamens anzeigen. Dort finden sich dann unter den Links _Corpus description_ und v.A. unter _Tagset summary_ auch noch weiterführende Informationen.
</SideNote>