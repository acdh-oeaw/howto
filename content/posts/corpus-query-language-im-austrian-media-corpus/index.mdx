...
<Quiz>
  ...
  <Quiz.Card>
    <Quiz.MultipleChoice variant="multiple">
      <Quiz.Question>
        Wie kann die CQL-Abfrage aussehen, um sowohl zu Token in Texten mit dem Ausdruck "sie sind wie Katz und Maus", "die Katze ist aus dem Sack", "eine Katze wartet im Tierheim", oder auch zum "Nobelpreisträger Bernhard Katz" zu finden
      </Quiz.Question>
