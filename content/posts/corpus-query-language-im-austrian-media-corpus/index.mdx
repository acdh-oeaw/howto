...
- `lc` : eine lower cased Version des Wortes. Die Suche in CQL ist _case sensitiv_, `lc` kann verwendet werden, um case _insensitiv_ -- also unter Großkleinschreibung ignorierend -- zu suchen. D.h. eine Suche \[word="Ciao"] findet nur genau „Ciao“. Die Suche \[lc="ciao"] findet ciao, Ciao, CIAO, CiAo etc.     
